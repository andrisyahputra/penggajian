 		...
 		<div class="row mt">
 			<div class="col-lg-12">
 				<div class="form-panel">
 					...
 					<form class="form-horizontal style-form" method="post" action="<?= base_url() ?>admin/DataJabatan/create_aksi">
 						...
 						<div class="form-group">
 							...
 							<div class="col-sm-10">
 								<input type="number" class="form-control" name="gaji_pokok" id="gaji_pokok" placeholder="Gaji Pokok">
 						...
 						<div class="form-group">
 							...
 							<div class="col-sm-10">
 								<input type="number" class="form-control" name="transport" id="transport" placeholder="Transport">
 						...
 						<div class="form-group">
 							...
 							<div class="col-sm-10">
 								<input type="number" class="form-control" name="uang_makan" id="uang_makan" placeholder="Uang Makanan">
