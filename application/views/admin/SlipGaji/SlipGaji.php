 		...
 		<div class="row mt">
 			...
 			<div class="col-lg-5">
 				<div class="form-panel">
 					<form action="<?= base_url('admin/SlipGaji/cetakSlipGaji') ?>" method="POST" class="form-horizontal style-form" target="_blank">
 						...
 						<div class="form-group">
 							...
 							<div class="col-md-8">
 								<select name="nama" id="nama" class="form-control">
 									...
 									<?php foreach ($namas as $key => $nama) : ?>
 										<option value="<?= $nama->id ?>"><?= $nama->nama_pegawai ?></option>
 									<?php endforeach ?>
 								</select>
 							</div>
 						</div>
